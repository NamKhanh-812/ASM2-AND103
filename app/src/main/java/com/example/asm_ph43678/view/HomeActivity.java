package com.example.asm_ph43678.view;
...
import com.example.asm_ph43678.MainActivity;
import com.example.asm_ph43678.R;
import com.example.asm_ph43678.adapter.FruitAdapter;
import com.example.asm_ph43678.databinding.ActivityHomeBinding;
import com.example.asm_ph43678.model.Fruit;
import com.example.asm_ph43678.model.Page;
import com.example.asm_ph43678.model.Response;
import com.example.asm_ph43678.services.HttpRequest;
...
//                        httpRequest.callAPI().getPageFruit("Bearer "+token, page).enqueue(getListFruitResponse);
        ...
        //spiner
        ArrayAdapter<CharSequence> spinnerAdapter = ArrayAdapter.createFromResource(this, R.array.spinner_price, android.R.layout.simple_gallery_item);
        ...
        binding.spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (value.toString().equals("Tăng")){
                    sort = "1";
                } else if (value.toString().equals("Giảm")) {
                    sort="-1";
                }
            }
    ...
    private void userListener () {
        ...
        binding.manDis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
